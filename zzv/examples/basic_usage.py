...
from zzv.common.logger_ai import init_logger_ai  # Ensure this module is in the correct location
from zzv.common.utility import load_config, should_start_server  # Ensure utility module is available
from zzv.engine.zeta_zen_vm import ZetaZenVm
from zzv.examples.example_manager import ExampleManager  # Import the ExampleManager
...
def main():
    ...
    engine = ZetaZenVm(config=config,
                       additional_managers=[{"name": "ExampleManager", "instance": example_manager_instance}])
